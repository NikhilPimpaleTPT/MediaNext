...
public class Sub_363519 {
	
	Boolean assertion = true;
	LinkedHashMap<String, String> dataSet = new LinkedHashMap<String, String>();

	String SubmissionName = "SUB_363519"+CommonElements.BROWSER+"A1";
	...
	public void setup() throws Exception {
		General.action().startSystem("SUB_363519");
		dataSet.put("TL_test_case_description","SUB-363519:Edit text of a Subtitle");
		dataSet.put("TL_internal_testCase_ID", "363519");
	}
	...
	public void testCase(LinkedHashMap<String, String> dataSet)
		...
		try {
			...
			Thread.sleep(2000);
			Pm_Transcription_Time(SubmissionName, "New");
			Thread.sleep(2000);
	...
	public void Pm_Transcription_Time(String SubmissionName, String status) throws Exception {
...
//			  Thread.sleep(1000);*/
	          ...
	          if(assertion =date.after(date1)){
			    ...
			    Transcription_textarea_text = General.driver.findElement(Pm_User_Submission_Locators.Locator().PM_Transcription_textarea(3)).getText();
				System.out.println("INPUT TEXT OF TEXTAREA:-" +Transcription_textarea_text);
				Thread.sleep(2000);
				...
				Thread.sleep(3000);
			     ...
			     Transcription_textarea_text_after_editing = General.driver.findElement(Pm_User_Submission_Locators.Locator().PM_Transcription_textarea(3)).getText();
				System.out.println("INPUT TEXT OF TEXTAREA AFTER EDITING:-" +Transcription_textarea_text_after_editing);
				
				
				assertion = Transcription_textarea_text != Transcription_textarea_text_after_editing;
				System.out.println("TRANSCRIPTION TEXT AREA IS NOT SIMILAR AFTER EDITING:-" +assertion);
				if (assertion == false) {
					report("f","Assertion failed while verifying transcription textarea Subtitle is not same after editing in subtitle after Search");
				}
				...
				Thread.sleep(2000);	
				General.action().type(Pm_User_Submission_Locators.Locator().PM_Transcription_Video_textarea,"Edited 5th segment");
				Thread.sleep(3000);
