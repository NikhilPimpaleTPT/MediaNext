...
public class Sub_686901 {
	
	Boolean assertion = true;
	LinkedHashMap<String, String> dataSet = new LinkedHashMap<String, String>();

	String SubmissionName = "SUB_686901" + CommonElements.BROWSER + "X1";
	...
	public void setup() throws Exception {
		General.action().startSystem("SUB_686901");
		dataSet.put("TL_test_case_description","SUB-686901:As a Transcriber, I need a search feature, so that I can navigate faster");
		dataSet.put("TL_internal_testCase_ID", "686901");
	}
	...
	public void testCase(LinkedHashMap<String, String> dataSet) throws Exception {
		try {
			...
			Thread.sleep(2000);
			Pm_Transcription_Update_Find_and_Replace(SubmissionName, targetlanguage_1, false, true);
			Thread.sleep(2000);
	...
	public void Pm_Transcription_Update_Find_and_Replace(String SubmissionName, String target, boolean complete,boolean back) throws Exception {
	...
	/*	General.action().waitforelemenetpresent(Pm_User_Submission_Locators.Locator().PM_Transcription_Video);
		...
		Thread.sleep(2000);
		General.action().type(Pm_User_Submission_Locators.Locator().PM_Transcription_Video,Keys.chord(Keys.ALT, "h"));
		Thread.sleep(3000);*/
		...
		boolean ReplaceBy_color = General.driver.findElement(Pm_User_Submission_Locators.Locator().PM_transcription_Find_and_replace_REPLACEBY).isDisplayed();
		System.out.println("ReplaceBy_color:-" + ReplaceBy_color);
		
	
		
		// verify assertion for color
		 assertion = General.driver.findElement(Pm_User_Submission_Locators.Locator().PM_transcription_Find_and_replace_REPLACEBY).isDisplayed();
		 if (assertion == false) {
			report("f","Assertion failed while verifying REPLACEBY IS NOT HIGHLIGHTED Name after Search	");
		}
	}
