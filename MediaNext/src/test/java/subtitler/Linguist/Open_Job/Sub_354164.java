...
public class Sub_354164 {
	
	Boolean assertion = true;
	LinkedHashMap<String, String> dataSet = new LinkedHashMap<String, String>();

	String SubmissionName = "SUB_354164"+CommonElements.BROWSER+"M1";
	...
	public void setup() throws Exception {
		General.action().startSystem("Sub_354164");
		dataSet.put("TL_test_case_description","Sub_354164: Translation Screen > Keyboard Shortcuts > Alt+enter");
		dataSet.put("TL_internal_testCase_ID", "354164");
	}
	...
	public void Trans_ongoing_keyboard_shortcuts(String SubmissionName,String target) throws Exception {
		...
		String keyborad_shortcut = General.driver.findElement(TranslatorLocators.Locator().keyborad_shortcut_save_and_go_to_next).getText();
		System.out.println("VALUE OF AIT+ENTER SHORTCUT KEY IS:-" +keyborad_shortcut);

		assertion = Verify.action().verifyElementValuePresent(TranslatorLocators.Locator().keyborad_shortcut_save_and_go_to_next, keyborad_shortcut, 5);
		if (assertion == false) {
			report("f","Assertion failed while verifying Trans_ongoing_keyboard_shortcuts  after Search");
		}
		...
		Thread.sleep(1000);
		  ...
		  Input_value_of_TargetSegement_textarea = General.driver.findElement(TranslatorLocators.Locator().translator_TargetSegement_textarea(3)).getText();
	    ...
	    General.action().type(TranslatorLocators.Locator().translator_TargetSegement_textarea(4),Keys.chord(Keys.ALT, Keys.ENTER));
		Thread.sleep(1000);
