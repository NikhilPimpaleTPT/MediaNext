 ...
 *Preconditions :case 1. User with the "Manage submissions" permission but without the "Manage server" permissions.

case 2.Users having "Manage Server" + "Manage Submissions" permissions.

Create a user with case 1, for case 2 modify the changes from admin
 */


public class Sub_2405343 {
	
	
	
	LinkedHashMap<String, String> dataSet = new LinkedHashMap<String, String>();
	String SubmissionName1 = "Submission_2405343"+CommonElements.BROWSER+"B1";
	String SubmissionName2 = "Submission_2405343"+CommonElements.BROWSER+"B2";
	String SubmissionName3 = "Submission_2405343"+CommonElements.BROWSER+"B3";
	...
	public void setup() throws Exception {
		General.action().startSystem("SUB_2405343");
		dataSet.put("TL_test_case_description", "SUB-2405343:Delete a Media.NEXT type submission in any status");
		dataSet.put("TL_internal_testCase_ID", "2405343");
	}
	...
	public void testCase(LinkedHashMap<String, String> dataSet)
		...
		try {
			 ...
			 if(Verify.action().verifyElementPresent(RoleLocators.Locator().Manage_role_unChecked(Roles_permission_View[1]),5)) {
			 Thread.sleep(2000);
