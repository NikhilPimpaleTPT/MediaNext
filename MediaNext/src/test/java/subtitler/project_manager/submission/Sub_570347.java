...
public class Sub_570347 {

	Boolean assertion = true;

	LinkedHashMap<String, String> dataSet = new LinkedHashMap<String, String>();

	String SubmissionName = "SUB_570347"+CommonElements.BROWSER+"V";
	...
	public void setup() throws Exception {
		General.action().startSystem("SUB_570347");
		dataSet.put("TL_test_case_description","SUB-570347:Translation/Review Screen > Use of special characters");
		dataSet.put("TL_internal_testCase_ID", "570347");
	}
...
//			File filepath = new File(System.getProperty("user.home")+ "\\Downloads\\");
			...
			for (String filename : filenames) {
              ...
              reader.close();
               ...
               boolean Finalresult = FileUtils.readFileToString(filepath1,CommonElements.UTF_8).contains("Login & Logout");
	...
	public void assertion() throws Exception {
		...
		assertion =  FileUtils.readFileToString(filepath1,CommonElements.UTF_8).contains("Login & Logout");;
