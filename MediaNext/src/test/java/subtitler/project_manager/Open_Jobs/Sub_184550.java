...
public class Sub_184550 {

	Boolean assertion = true;
	LinkedHashMap<String, String> dataSet = new LinkedHashMap<String, String>();

	String SubmissionName = "SUB_184550"+CommonElements.BROWSER+"M1";
	...
	public void setup() throws Exception {
		General.action().startSystem("Sub_184550");
		dataSet.put("TL_test_case_description", "Sub_184550:To claim job");
		dataSet.put("TL_internal_testCase_ID", "184550");
	}
	...
	public void PM_ToClaim(String SubmissionName) throws Exception {
		...
		if (assertion == false) {
			report("f","Assertion failed while verifying PM_claimAlert_claim_button after Search");
		}
		...
		if (assertion == false)
			report("f","Assertion failed while verifying message for PM_ToClaim_message");
