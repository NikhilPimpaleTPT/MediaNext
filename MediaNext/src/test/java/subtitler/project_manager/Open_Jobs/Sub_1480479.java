 ...
 *                                                                   
 * @author pvaidya                                                   
 *Summary: Check Chinese translated file after download.
 *Preconditions :Use the attached file to create the submission.
 */ 
public class Sub_1480479 {
	
	Boolean assertion = true;
	LinkedHashMap<String, String> dataSet = new LinkedHashMap<String, String>();
	String SubmissionName = "SUB_1480479"+CommonElements.BROWSER+"M56";
    String OrganizationName = "Subtitle_Common_orgs";
    String target_language="zh-CN";
	...
	String chineseText[]= {"感謝您的收看，我希望您能與VideoSub圖書館一起玩得開心。","專業提示：關閉相機閃光燈。","啊，是的，這是更好的。","顫抖的手。","伙計 - 走開。","在蒙特利水族館的水母。"};
	File filepath1;
	
	@BeforeMethod
	public void setup() throws Exception {General.action().startSystem("SUB_1480479");
		dataSet.put("TL_test_case_description", "SUB-1480479:Check chinese translated file after download.");
		dataSet.put("TL_internal_testCase_ID", "1480479");
	}
	...
	public void testCase(LinkedHashMap<String, String> dataSet)
		...
		try {
			...
			PM_user.action().CreateSubmisson_Step3_VideoSRTFile(CommonElements.action().FILE_ABSOLUTE_PATH+ CommonElements.action().FILE_COMMON_FOLDER+ CommonElements.action().FILE_COMMON_CHINESE_SRT_FOLDER);
			PM_user.action().CreateSubmisson_Step4_MetaData(CommonElements.action().DATE_OFFSET,SubmissionName,CommonElements.action().COMMON_SOURCE_LANGUAGE,target_language);
			Thread.sleep(8000);
			...
			Thread.sleep(1000);
			//ENTER CHINESE TEXT IN TARGET SEGMENT
			...
			//VERIFY SRT FILE CONTAINS ENTER CHINESE SEGMENTS 
	...
	public void PM_onGoing_submission(String SubmissionName, String target,boolean complete,boolean back) throws Exception {
		 ...
		 //VERIFY TARGET SEGMENT CONTAINS CHINESE TEXT
	     ...
	     if (assertion == false) {
		 report("f","Assertion failed while verifying target sement contains Chinese text .");
